...
export default function MyEventsComponentModified({ props }) {

  const navigate = useNavigate()

  const goToSinglePage = () => {
    sessionStorage.setItem("itemIdForSingleEvent", props.id)
    navigate("/singleEventModified")
    window.scrollTo(0, 0)
  }
  ...
  return (
    <div className='trending-events-div-1' onClick={goToSinglePage}>
        ...
        {
          props.changed === 1 ? <div className='trending-events-approved-div'> <h3>Changed</h3></div> 
